      ...
      this.connectionAcceptor = RSocketServer
          ...
          .acceptor(new SocketAcceptor() {
            ...
            public Mono<RSocket> accept(ConnectionSetupPayload connectionSetupPayload, RSocket rSocket) {
              ...
              Optional<String> connectionRouteOpt = extracteRoute(connectionSetupPayload.metadata());
              // http headers
              return Mono.just(new RSocket() {
                @Override
                public Mono<Void> fireAndForget(Payload payload) {

                  Optional<String> connectionRouteOpt = extracteRoute(payload.metadata());
                  extracteDataMimeType(payload.metadata());
...
//  }
  ...
  static Optional<String> extracteRoute(ByteBuf metadata) {
